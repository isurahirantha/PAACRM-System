...
<div class="content">
	...
	<a href="./MsgController?prof_id=${joins.professional_id}&client_id=${joins.client_id}">
	${joins.professional_name}
	</a>
...
<!-- auto_id	professional_id	client_id	message	isOpen	date_msg	time_msg -->
		...
		<c:forEach items="${chatList}" var="chats">
      	...
      	<div class="content">
      	<!-- METHOD POST -->
			 <form class="form-horizontal" action="./MsgController?prof_id=${msgB.professional_id}&client_id=${msgB.client_id}" method="post">
