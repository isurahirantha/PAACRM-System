...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <li><a href="#" data-toggle="tooltip" data-placement="bottom" title="Home"><span><i class="fa fa-home"></i></span></a></li>
           ...
           <%=fullname %>
            <span class="caret"></span></a>
                ...
                <li><a href="./ClientController?profile=profile"><span class="fa fa-cog"></span>&nbsp;&nbsp;Account settting</a></li>
